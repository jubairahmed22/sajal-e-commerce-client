    ...
    <div>
      ...
      <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
          ...
          <div class="mt-6 sm:hidden sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
            {cart.length === 0 ? (
          ...
          <div className="lg:hidden w-full flex flex-col justify-between">
          {cart.length === 0 ? (
              <p>Your cart is empty</p>
            ) : (
              <div>
                {cart.map((item) => (
                         <div className="lg:hidden w-full flex flex-col justify-between border-b border-gray-200 pb-2">

                         <div className="w-full flex flex-row justify-between items-center gap-2">
                         <div>
                         <a  class="shrink-0 md:order-1">
                            <img
                              class="h-14 w-14 dark:hidden"
                              src={item.singleImage}
                              alt="imac image"
                            />
                            <img
                              class="hidden h-14 w-14 dark:block"
                              src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg"
                              alt="imac image"
                            />
                          </a>
                         ...
                         <div>
                          <h1 className="text-sm">{item.sellingPrice * item.quantity} tk</h1>
                         </div>
            ...
            <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full w-[100%]">
              <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                <p class="text-xl font-semibold text-gray-900 dark:text-white">
                  Order summary
                </p>
                ...
                <div class="space-y-4">
                  <dl class=" border-t border-gray-200 pt-2 dark:border-gray-700">
                    <form onSubmit={handleSubmit}>
                      ...
                      {cart.length > 0 && (
                        <dd class="font-bold text-gray-600 dark:text-white mb-6 text-xl">
                          Total <span className="text-gray-900">{calculateTotalPrice()} Tk</span>
                        </dd>
                      )}
